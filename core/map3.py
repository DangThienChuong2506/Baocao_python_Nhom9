...
POSSIBLE_NAMES = ['background3.png', 'background3.jpg', 'background3.jpeg']
...
def _ensure_min_width(surface, min_width):
    ...
    if width >= min_width:
        return surface
    repeats = math.ceil(min_width / max(1, width))
...
def load_bg(screen_width):
    """Load map3 background scaled to screen height with ample width."""
